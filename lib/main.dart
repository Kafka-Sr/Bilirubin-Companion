...
class _DashboardPageState extends ConsumerState<DashboardPage> {
      ...
      children: [
        ...
        PopupMenuButton<String>(
          ...
          itemBuilder: (context) => [
            ...
            PopupMenuItem(value: 'settings', child: Text(strings.t('goSettings'))),
          ],
        ),
        IconButton(
  ...
  Widget _metadataCard(BuildContext context, Baby? baby) {
    ...
    final ageText = '${age.inHours}h ${(age.inMinutes % 60)}m';
    return Card(
      child: Padding(
        padding: const EdgeInsets.all(12),
        child: Column(
          ...
          children: [
            Row(
              children: [
                const Expanded(
                  child: Text('Metadata Bayi', style: TextStyle(fontWeight: FontWeight.bold)),
                ),
                IconButton(
            ...
            Text('name: ${baby.name}'),
            Text('weight_kg: ${baby.weightKg.toStringAsFixed(1)}'),
            Text('age: $ageText'),
            Text('date_of_birth: ${baby.dateOfBirth.toLocal()}'),
          ],
        ),
      ),
    );
